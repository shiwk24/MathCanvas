...
def add_special_tokens(tokenizer):
    ...
    new_tokens = []
    base_tokens = ['<|im_start|>', '<|im_end|>', '<|vision_start|>', '<|vision_end|>', '<|endoftext|>']
...
def add_reason_special_tokens(tokenizer):
    all_special_tokens = []
    for k, v in tokenizer.special_tokens_map.items():
        if isinstance(v, str):
            all_special_tokens.append(v)
    ...
    new_tokens = []
    base_tokens = ['<|im_start|>', '<|im_end|>', '<|vision_start|>', '<|vision_end|>', '<|reason_end|>']
    ...
    new_token_ids = dict(
        ...
        start_of_image=tokenizer.convert_tokens_to_ids('<|vision_start|>'),
        end_of_image=tokenizer.convert_tokens_to_ids('<|vision_end|>'),
        end_of_reason=tokenizer.convert_tokens_to_ids('<|reason_end|>'),
    )
